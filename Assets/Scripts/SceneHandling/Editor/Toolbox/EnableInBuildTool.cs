...
namespace SceneHandling.Editor.Toolbox
{
    ...
    internal class EnableInBuildTool : ITool
    {
        ...
        public EnableInBuildTool(string scenePath, string sceneGuid, Object sceneAsset)
        {
        ...
        {
            string title = "Enable Scene in Build Settings?";
            string body = $"Would you like to enable the following scene in build settings?\n\n{_scenePath}";
