...
namespace SceneHandling.Editor.Toolbox
{
    ...
    internal class AddToBuildTool : ITool
    {
        ...
        public AddToBuildTool(string scenePath, Object sceneAsset)
        {
        ...
        {
            string title = "Add Scene to Build Settings?";
            string body = $"Would you like to add the following scene to build settings?\n\n{_scenePath}";
