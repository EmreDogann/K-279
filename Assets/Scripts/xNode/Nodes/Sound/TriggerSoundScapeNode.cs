...
namespace xNode.Nodes.Sound
{
    ...
    public class TriggerSoundScapeNode : BaseNode
    {
        ...
        [SerializeField] private readonly SoundType soundType = SoundType.Explosion;
        [SerializeField] private readonly ShakeOverride shakeOverride = ShakeOverride.DefaultShake;
