...
namespace Utils.Editor
{
    public class UnityYAMLClassID
    {
        public static Dictionary<int, string> IDToType = new Dictionary<int, string>
        {
            ...
            // There is no references to a 'SceneRoots' YAML Class ID that I could find online, but for some reason it appears at the end of .unity scene files. Yet another undocumented Unity thing :/
